...
class TestGetModel:
    ...
    def test_anthropic_returns_chat_anthropic(self, _base_settings) -> None:
    ...
    def test_openai_returns_chat_openai(self, _base_settings) -> None:
    ...
    def test_ollama_returns_chat_openai_with_custom_base(self, _base_settings) -> None:
        """Ollama provider should return ChatOpenAI with custom base_url."""
        _base_settings.model = "ollama:llama3"
        model = _get_model(_base_settings)
        assert isinstance(model, ChatOpenAI)

    def test_bedrock_returns_chat_bedrock(self, _base_settings) -> None:
    ...
    def test_missing_api_key_raises_value_error(self, _base_settings) -> None:
    ...
    def test_bare_claude_auto_routes_to_anthropic(self, _base_settings) -> None:
